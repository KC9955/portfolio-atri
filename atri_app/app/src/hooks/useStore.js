...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "TextBox96": {
      "custom": {
        "text": "Over the past 12 years, I've worked with a diverse range of clients, from startups to Fortune 500 companies. I love crafting interfaces that delight users and help businesses gro"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image40": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Stanford_University_seal_2003.svg.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image58": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/down%20arrow.svg"
      },
      "callbacks": {
        "onClick": [
          {
