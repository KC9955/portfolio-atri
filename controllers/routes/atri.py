...
class Atri:
	def __init__(self, state: Any):
		...
		self.dropabout = state["dropabout"]
		self.dropservice = state["dropservice"]
		self.dropproject = state["dropproject"]
		self.dropblog = state["dropblog"]
	...
	@property
	def dropabout(self):
		self._getter_access_tracker["dropabout"] = {}
		return self._dropabout
	@dropabout.setter
	def dropabout(self, new_state):
		self._setter_access_tracker["dropabout"] = {}
		global default_state
		self._dropabout = TextBox(new_state, default_state["dropabout"])

	@property
	def dropservice(self):
		self._getter_access_tracker["dropservice"] = {}
		return self._dropservice
	@dropservice.setter
	def dropservice(self, new_state):
		self._setter_access_tracker["dropservice"] = {}
		global default_state
		self._dropservice = TextBox(new_state, default_state["dropservice"])

	@property
	def dropproject(self):
		self._getter_access_tracker["dropproject"] = {}
		return self._dropproject
	@dropproject.setter
	def dropproject(self, new_state):
		self._setter_access_tracker["dropproject"] = {}
		global default_state
		self._dropproject = TextBox(new_state, default_state["dropproject"])

	@property
	def dropblog(self):
		self._getter_access_tracker["dropblog"] = {}
		return self._dropblog
	@dropblog.setter
	def dropblog(self, new_state):
		self._setter_access_tracker["dropblog"] = {}
		global default_state
		self._dropblog = TextBox(new_state, default_state["dropblog"])
	...
	def _to_json_fields(self):
		return {
			...
			"call": self._call,
			"arrow": self._arrow,
			"dropabout": self._dropabout,
			"dropservice": self._dropservice,
			"dropproject": self._dropproject,
			"dropblog": self._dropblog,
